...
num_modes = 3  # number of modes to calculate
...
section2 = Section(area=104000, ixx=88.3e7)
# create nodes
...
for i in range(num_nodes - 1):
    elements.append(analysis.create_element(
        ...
        material=steel,
        section=section2 if i > (num_nodes / 2) else section
    ))
...
freedom_case.add_nodal_support(node=nodes[-10], val=0, dof=0)
